...
# DeBERTa-v3-Small PII Redaction
...
Two-phase Fine-tuning (frozen backbone → unfrozen) from [`microsoft/deberta-v3-small`](https://huggingface.co/microsoft/deberta-v3-small) using a weighted token-classification trainer and stage-specific learning rates.
...
[1] see [DeBERTa-v3-XSmall PII Redaction](https://huggingface.co/bengid/pii-redaction-deberta-xsmall/#latency-note) for latency explanation
